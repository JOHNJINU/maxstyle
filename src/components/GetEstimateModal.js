...
class GetEstimateModal extends Component {
  ...
  sendEstimate(e) {
    ...
    axios
      .post("http://192.168.64.2/admin/api/getEstimate.php", estimateData)
      .then((response) => {
        console.log(response);

        let contactUsStatusMessage = document.querySelector(
          ".contactUsStatusMessage"
        );
        let nonStatusItemsContainer = document.querySelector(
          ".nonStatusItemsContainer"
        );
